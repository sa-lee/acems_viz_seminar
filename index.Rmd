...
1. Data containing lat/long with geographical regions
]
...
2. Compute some summary over a geographical region. Here we compute relative
...
3. Join the geographical regions to the summary data.
]
...
library(plotly)
map <- map + geom_text(aes(label = country))
ggplotly(map, tooltip = c("label", "fill"))
```
